...
(* OASIS_START *)
(* DO NOT EDIT (digest: fe262e7dc6046e93b31707dafe907cb5) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install the IO system";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build and install iterators";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build and install the Extlib compatibility interface";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build and install text-handling facilities (utf8, ...)";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                     cs_name = "batteries_exceptionless";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["BatteriesExceptionless"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "batteries";
                      lib_findlib_name = Some "exceptionless";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "batteries_data";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["BatRMutex"; "BatMutex"; "BatteriesThread"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "batteries";
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "\179\196X\205/\199\209S\229\230\1968\0220\133\130";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
