...
(** {6 File permissions} *)
type permission = Extlib.File.permission
...
val open_file_in : ?mode:(Extlib.File.open_in_flag list) -> ?perm:Extlib.File.permission -> string -> Extlib.IO.input
...
val with_file_in : ?mode:(Extlib.File.open_in_flag list) -> ?perm:Extlib.File.permission -> string -> (Extlib.IO.input -> 'a) -> 'a
...
val open_file_out : ?mode:(open_out_flag list) -> ?perm:permission -> string -> unit Extlib.IO.output
...
val with_file_out: ?mode:(open_out_flag list) -> ?perm:permission -> string -> (unit Extlib.IO.output -> 'a) -> 'a
