...
##V>=4.3##val num_bits_big_int : big_int -> int
##V>=4.3##        (** Return the number of significant bits in the absolute
##V>=4.3##            value of the given big integer.  [num_bits_big_int a]
##V>=4.3##            returns 0 if [a] is 0; otherwise it returns a positive
##V>=4.3##            integer [n] such that [2^(n-1) <= |a| < 2^n].
