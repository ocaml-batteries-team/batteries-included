...
(* OASIS_START *)
(* DO NOT EDIT (digest: e4262f1695ce097a00ca6d52cfc477f6) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install additional data structures";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("batteries.io", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "3v4\003+\235U|\n\174Yj\1919\182\142";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
