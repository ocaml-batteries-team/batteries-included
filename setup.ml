...
(* OASIS_START *)
(* DO NOT EDIT (digest: e8828f593b29fb109c81258f08939b28) *)
(*
...
# 21 "/home/typhon/kamlo/oasis/src/plugins/custom/CustomPlugin.ml"
       ...
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("echo", ["\"configured\""]))];
     ...
     package =
       {
          ...
          description = None;
          categories = [];
          conf_type = (`Configure, "custom", Some "0.2");
          conf_custom =
            {
