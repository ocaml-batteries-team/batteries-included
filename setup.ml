...
(* OASIS_START *)
(* DO NOT EDIT (digest: 33bd1152709d7211e834bdde60f255aa) *)
(*
...
# 21 "/home/thelema/ocamlbrew/ocaml-4.00.0/build/odb/install-oasis/oasis-0.3.0/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\173o\233\207\168\156\141\216&\178\130\154\175\248\170\231";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
