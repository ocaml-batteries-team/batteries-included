  ...
  module Private_state_gens : sig
    module State : sig (** same as BatRandom.State *)
      ...
      (** A copy of the input state is made to start these generators;
          the input state is not modified.  This means that two gens
    ...
    (** These generations are built on a copy of the global RNG
