...
val add_input : t -> BatInnerTypes.input -> int -> unit
...
val add_channel : t -> BatInnerTypes.input -> int -> unit
(** @obsolete replaced by {!add_input}*)

val output_buffer : t -> string BatInnerTypes.output
...
val enum : t -> char BatInnerTypes.enum
...
val of_enum : char BatInnerTypes.enum -> t
